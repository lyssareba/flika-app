 ...
 */
export async function triggerDatingRecap(_userId: string): Promise<void> {
 ...
 */
export async function cleanupExpiredProspects(_userId: string): Promise<void> {
  // TODO: Implement when Cloud Functions are set up
 ...
 */
export async function sendArchiveExpirationWarning(
  _userId: string,
  _prospectId: string
): Promise<void> {
  // TODO: Implement when Cloud Functions are set up
 ...
 */
export async function exportUserData(_userId: string): Promise<string> {
  // TODO: Implement when Cloud Functions are set up
 ...
 */
export async function scheduleAccountDeletion(_userId: string): Promise<Date> {
  // TODO: Implement when Cloud Functions are set up
